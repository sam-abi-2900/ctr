...
import { ChevronLeft, Check, X, Upload, Clock, MapPin, Package, Camera } from 'lucide-react-native';
...
export default function WarehouseTasksScreen() {
        ...
        const fetchEventData = async () => {
            try {
                ...
                if (currentEvent) {
                    ...
                    // Filter tasks based on event type (warehouse tasks for this screen)
                    const warehouseTasks = currentEvent.tasks.filter(task => task.type === 'warehouse');
                    setTasks(warehouseTasks);
                } else {
                        ...
                        { text: "Cancel", style: "cancel" },
                        {
                            ...
                            onPress: () => router.push({
                                ...
                                params: {
                                    ...
                                    currentStage: 'warehouse_checkout',
                                    nextStage: 'truck_checkin',
                                    eventType: params.eventType,
                                    warehouseTime: elapsedTime.toString(),
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Warehouse Tasks</Text>
            ...
            <TouchableOpacity
                ...
                activeOpacity={0.8}
            >
                <Text style={styles.checkOutButtonText}>Check Out from Warehouse</Text>
            </TouchableOpacity>
